...
find $API_TMP_DIR -type f -samefile './libs/nodejs-messaging/package.json' -exec sh -c 'sed -i "s/googleapis/enfonica-node\/libs/" "$1"' -- {} \;
...
find $API_TMP_DIR -type f -samefile './libs/nodejs-numbering/package.json' -exec sh -c 'sed -i "s/googleapis/enfonica-node\/libs/" "$1"' -- {} \;
...
find $API_TMP_DIR -type f -samefile './libs/nodejs-voice/package.json' -exec sh -c 'sed -i s=\"voice=\"@enfonica/voice=g "$1"' -- {} \;
...
find $API_TMP_DIR -type f -samefile './libs/nodejs-voice/package.json' -exec sh -c 'sed -i "s/Voice client for Node.js/Enfonica Numbering SDK for Node.js/" "$1"' -- {} \;
find $API_TMP_DIR -type f -samefile './libs/nodejs-voice/package.json' -exec sh -c 'sed -i "s/googleapis/enfonica-node\/libs/" "$1"' -- {} \;
...
find $API_TMP_DIR -type f -samefile './libs/nodejs-messaging/package.json' -exec sh -c 'sed -i "s/0.1.0/1.0.0-alpha.3/" "$1"' -- {} \;
find $API_TMP_DIR -type f -samefile './libs/nodejs-numbering/package.json' -exec sh -c 'sed -i "s/0.1.0/1.0.0-alpha.3/" "$1"' -- {} \;
find $API_TMP_DIR -type f -samefile './libs/nodejs-voice/package.json' -exec sh -c 'sed -i "s/0.1.0/1.0.0-alpha.3/" "$1"' -- {} \;
