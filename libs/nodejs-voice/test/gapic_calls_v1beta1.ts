...
describe('v1beta1.CallsClient', () => {
    ...
    describe('getCall', () => {
        it('invokes getCall without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.enfonica.voice.v1beta1.GetCallRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.enfonica.voice.v1beta1.Call());
            client.innerApiCalls.getCall = stubSimpleCall(expectedResponse);
            const [response] = await client.getCall(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCall as SinonStub)
        ...
        it('invokes getCall without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.enfonica.voice.v1beta1.Call());
            client.innerApiCalls.getCall = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCall(
                    request,
                    (err?: Error|null, result?: protos.enfonica.voice.v1beta1.ICall|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listCalls', () => {
        it('invokes listCalls without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.enfonica.voice.v1beta1.ListCallsRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listCalls as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listCalls without error using callback', async () => {
            ...
            client.innerApiCalls.listCalls = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listCalls(
                    request,
                    (err?: Error|null, result?: protos.enfonica.voice.v1beta1.ICall[]|null) => {
        ...
        it('invokes listCallsStream without error', async () => {
            ...
            client.descriptors.page.listCalls.createStream = stubPageStreamingCall(expectedResponse);
            ...
            assert((client.descriptors.page.listCalls.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCalls, request));
            assert.strictEqual(
        ...
        it('invokes listCallsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listCalls.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCallsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.enfonica.voice.v1beta1.Call[] = [];
                stream.on('data', (response: protos.enfonica.voice.v1beta1.Call) => {
        ...
        it('uses async iteration with listCalls without error', async () => {
            ...
            client.descriptors.page.listCalls.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listCalls.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listCalls with error', async () => {
            ...
            client.descriptors.page.listCalls.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCallsAsync(request);
