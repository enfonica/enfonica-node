...
describe('v1.MessagesClient', () => {
    ...
    describe('createMessage', () => {
        it('invokes createMessage without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.enfonica.messaging.v1.CreateMessageRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.enfonica.messaging.v1.Message());
            ...
            assert((client.innerApiCalls.createMessage as SinonStub)
        ...
        it('invokes createMessage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createMessage(
                    request,
                    (err?: Error|null, result?: protos.enfonica.messaging.v1.IMessage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMessage', () => {
        it('invokes getMessage without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.enfonica.messaging.v1.GetMessageRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMessage as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listMessages', () => {
        it('invokes listMessages without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.enfonica.messaging.v1.ListMessagesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listMessages as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
